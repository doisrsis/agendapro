                    ...
                    <div class="row">
                        <div class="col-md-4">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" name="config[telefone]"
                                    value="<?= get_config_value($configs, 'telefone') ?>">
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="mb-3">
                                <label class="form-label">WhatsApp</label>
                                <input type="text" class="form-control" name="config[whatsapp]"
                                    value="<?= get_config_value($configs, 'whatsapp') ?>"
