<?php
/**
 * View: Pagamento de Agendamento via PIX (Painel Profissional)
 *
            ...
            <div class="col-md-8 col-lg-6">
                <div class="card">
                    ...
                    <div class="card-body text-center">
                        ...
                        <!-- Botão Voltar -->
                        <div class="mt-4">
                            <a href="<?= base_url('agenda/dashboard') ?>" class="btn btn-outline-secondary">
...
const intervaloPagamento = setInterval(() => {
    fetch('<?= base_url("agenda/agendamentos/verificar_pagamento/{$agendamento->id}") ?>')
        .then(r => r.json())
        .then(data => {
            ...
            if (data.status === 'pago') {
                ...
                Swal.fire({
                    ...
                    window.location.href = '<?= base_url("agenda/dashboard") ?>';
                });
