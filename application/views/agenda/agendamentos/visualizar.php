...
<!--
 * View de visualização de agendamento - Painel do Profissional
    ...
    <div class="container-xl">
        <div class="row g-2 align-items-center">
            ...
            <div class="col-auto ms-auto">
                <div class="btn-list">
                    <a href="<?= base_url('agenda/agendamentos/editar/' . $agendamento->id) ?>" class="btn btn-primary">
                        <i class="ti ti-edit me-1"></i>
                        Editar
                    </a>
                    <a href="<?= base_url('agenda/dashboard') ?>" class="btn">
                    ...
                    <div class="card-body">
                        <div class="datagrid">
                            ...
                            <div class="datagrid-item">
                                ...
                                <div class="datagrid-content"><?= $agendamento->cliente_whatsapp ?? '-' ?></div>
                            </div>
                            <div class="datagrid-item">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="d-grid gap-2">
                            ...
                            <a href="<?= base_url('agenda/agendamentos/iniciar/' . $agendamento->id) ?>" class="btn btn-success">
                            ...
                            <a href="<?= base_url('agenda/agendamentos/finalizar/' . $agendamento->id) ?>" class="btn btn-success">
                                <i class="ti ti-player-stop me-1"></i>
                                Finalizar Atendimento
                            </a>
                            <?php endif; ?>

                            <?php if (!in_array($agendamento->status, ['cancelado', 'concluido', 'finalizado'])): ?>
